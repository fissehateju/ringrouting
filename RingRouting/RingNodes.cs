...
namespace RR.RingRouting
{
    ...
    public class RingNodes
    {
        ...
        public Dictionary<int, SinksAgentsRow> AnchorNodes { get; set; }
        ...
        public RingNodes(Sensor me, Sensor next, Sensor prev)
        {
            ...
            AnchorNodes = new Dictionary<int, SinksAgentsRow>();
        ...
        public bool haveAllSinksPosition()
        {
            ...
            foreach (KeyValuePair<int, SinksAgentsRow> pair in AnchorNodes)
            {
